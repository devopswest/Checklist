...
/**
 * Performance test for the AuditProfile entity.
 */
class AuditProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AuditProfile entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all auditProfiles")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created auditProfile")
                .get("${new_auditProfile_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created auditProfile")
            .delete("${new_auditProfile_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
